...
namespace evfa
{
    ...
    {
        private jdTab jdt;
        private prfpdTab prftb;
        private OBSTab obstb1;
        private OBSTab obstb2;
        private prfTabdet prftabdet;
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            this.ActionBar.SetIcon(Resource.Drawable.Users);
            //add tabs            
            jdt = new jdTab();
            prftb = new prfpdTab();
            obstb1 = new OBSTab();
            obstb2 = new OBSTab();
            prftabdet = new prfTabdet();
            AddTab("Job", Resource.Drawable.Users, jdt);
            AddTab("Prf", Resource.Drawable.Details, prftb);
            AddTab("Dets", Resource.Drawable.Details, prftabdet);
            AddTab("Obs1", Resource.Drawable.eye32321, obstb1);
            AddTab("Obs2", Resource.Drawable.eye32322, obstb2);
    ...
    class jdTab : Fragment
    {
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            base.OnCreateView(inflater, container, savedInstanceState);

            var view = inflater.Inflate(Resource.Layout.jdTab, container, false);
            return view;
        }
    }
    class prfTabdet : Fragment
    {
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            base.OnCreateView(inflater, container, savedInstanceState);

            var view = inflater.Inflate(Resource.Layout.prfTabdet, container, false);
            return view;
        }
    }
    class prfpdTab : Fragment
    {
        // patient details
      //  private prfTabpd prfpd;
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            base.OnCreateView(inflater, container, savedInstanceState);
